...
export const AdminApi = {
  ...
  businessSuppliers: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/suppliers`)).data),
  businessPurchases: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/purchases`)).data),
  businessExpenses: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/expenses`)).data),
  businessCashbook: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/cashbook`)).data),
  businessStaff: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/staff`)).data),
  businessSupportTickets: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/support-tickets`)).data),
  businessAuditLogs: async (publicId) => toArray((await apiRequest(`/api/admin/businesses/${publicId}/audit-logs`)).data),
